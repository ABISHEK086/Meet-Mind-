      ...
      <div className="flex items-center justify-center px-5 py-8 sm:px-10 sm:py-16">
        <div className="w-full max-w-md">
          ...
          <form className="space-y-4 text-left" onSubmit={handleSubmit}>
            ...
            <label className="flex items-start gap-2.5 pt-1 text-xs leading-relaxed text-ink-300">
              <input type="checkbox" required className="mt-0.5 h-3.5 w-3.5 rounded border-line-strong accent-[var(--color-accent)]" />
